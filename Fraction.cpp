...
Fraction::Fraction(inputInt num, inputInt denom)
{
   assert(denom != (0));
...
Fraction::Fraction(inputInt num) :
      numerator(abs(num)), denominator(1), sign(num > 0 ? positive : negative)
{

}

Fraction::Fraction(internalInt num, internalInt denom, Sign _sign) :
...
Fraction::Fraction(internalInt num) :
